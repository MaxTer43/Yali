...
module.exports = {
    ...
    async execute(interaction){
        ...
        const doc = await DB.find({specie: specie, type: 'Tails'});
        if (doc.length === 0){
        ...
        doc.forEach((t) => list.push(t._id.toString()),);
        doc.forEach((t) => trait.push(t.trait.toString()),);
        doc.forEach((t) => frequency.push(t.frequency.toString()),);
